package bitpikteam.project.bitcamp.ba.bitpik;
     ...
     //       sendLogin(username, password);
        ...
        mLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EditText usernameEdit = (EditText) findViewById(R.id.edit_text_username);
                ...
                editor.putString(getString(R.string.user_username_key), username);
...
/*
    ...
    {
        Intent postInt = new Intent(this, IndexPage.class);
